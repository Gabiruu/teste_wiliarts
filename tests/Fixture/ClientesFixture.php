...
class ClientesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'telefone' => ['type' => 'string', 'length' => 11, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'telefone' => 'Lorem ips',
                'created' => '2021-07-27 21:39:04',
                'modified' => '2021-07-27 21:39:04',
            ],
        ];
        parent::init();
    }
